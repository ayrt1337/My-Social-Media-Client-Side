...
const Login = () => {
    ...
    return (
        <>
            ...
            <div className="max-[581px]:pt-8 max-[581px]:pb-8 pt-13 pb-13 max-[581px]:bg-[#000000] flex flex-col items-center bg-[#0f0f0f] min-h-[100vh] justify-center">
                <div className="max-[460px]:pr-7 max-[460px]:pl-7 max-[581px]:w-full text-center flex flex-col items-center justify-between bg-[#000000] rounded-[15px] pb-13 pl-10 pr-10 text-[#FFFFFF]">
                    <div className="flex flex-col items-center m-10 w-full text-[15px]">
                        <img src={Image} className="max-[460px]:h-auto max-[460px]:max-w-[100%] max-w-[300px]"></img>
                        ...
                        <div className="flex w-full items-stretch mb-5">
