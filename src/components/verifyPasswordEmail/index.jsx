    ...
    return (
        <>
            ...
            <div className="max-[590px]:pt-8 max-[590px]:pb-8 pt-13 pb-13 max-[590px]:bg-[#000000] flex flex-col items-center bg-[#0f0f0f] min-h-[100vh] justify-center">
                {showInputs &&
                    <div className="max-[430px]:pr-5 max-[430px]:pl-5 max-[590px]:w-full text-center flex flex-col items-center justify-between bg-[#000000] rounded-[15px] pl-10 pr-10 text-[#FFFFFF]">
